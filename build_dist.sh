#!/usr/bin/env sh
#
# Borrowed from https://github.com/tailscale/tailscale/blob/18c61afeb9ebec3169aab0e2fa75c996de84a250/build_dist.sh
#
...
# issues.
#
# If you're packaging Tier for a distro, please consider using
...
tags=""
ldflags="-X tier.run/version.Long=${LONG} -X tier.run/version.Short=${SHORT} -X tier.run/version.GitCommit=${GIT_HASH}"
