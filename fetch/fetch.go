package fetch // import "tier.run/fetch"
...
func Fetch[R any](ctx context.Context, c *http.Client, method, urlStr string, body any, opts ...any) (R, error) {
	var zero R
...
func FetchOK[R any, E error](ctx context.Context, c *http.Client, method, urlStr string, body any, opts ...any) (R, error) {
	var zero R
	res, err := Fetch[*http.Response](ctx, c, method, urlStr, body, opts...)
	if err != nil {
		return zero, err
	}
