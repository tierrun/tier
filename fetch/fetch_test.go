...
func TestFetch(t *testing.T) {
	...
	t.Run("string", func(t *testing.T) {
		...
		got, err := Fetch[string](ctx, c, "GET", "/", nil)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("[]byte", func(t *testing.T) {
		...
		got, err := Fetch[[]byte](ctx, c, "GET", "/", nil)
		if err != nil {
			t.Fatal(err)
		}
		diff.Test(t, t.Errorf, got, want)
	...
	t.Run("some_struct", func(t *testing.T) {
		...
		got, err := Fetch[hello](ctx, c, "GET", "/", nil)
		if err != nil {
			t.Fatal(err)
		}
		want := hello{"world"}
	...
	t.Run("int", func(t *testing.T) {
		...
		got, err := Fetch[int](ctx, c, "GET", "/", nil)
		if err != nil {
			t.Fatal(err)
		}
		want := 1
	...
	t.Run("*bytes.Buffer", func(t *testing.T) {
		...
		got, err := Fetch[*bytes.Buffer](ctx, c, "GET", "/", nil)
		if err != nil {
			t.Fatal(err)
		}
...
func TestFetchOK(t *testing.T) {
	...
	t.Run("error_custom", func(t *testing.T) {
		...
		_, got := FetchOK[int, TE](ctx, c, "GET", "/", nil)
		var want TE
	...
	t.Run("error_client", func(t *testing.T) {
		...
		_, err := FetchOK[int, TE](ctx, c, "GET", "/", nil)
